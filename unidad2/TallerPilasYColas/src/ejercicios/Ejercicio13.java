...
//Dada una Cola de Personas (nombre, edad, sexo), escribir un método que quite de la cola a los hombres cuya edad está
// entre los 30 y 50 años, los demás elementos de la Cola deben quedar en el mismo orden en el que estaban originalmente.
